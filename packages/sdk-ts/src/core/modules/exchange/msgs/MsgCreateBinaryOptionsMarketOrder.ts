...
export declare namespace MsgCreateBinaryOptionsMarketOrder {
  ...
  export type Proto =
    InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsMarketOrder
}
...
const createMarketOrder = (
  ...
  const message =
    InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsMarketOrder.create({
...
> {
  ...
  public toBinary(): Uint8Array {
    return InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsMarketOrder.toBinary(
      this.toProto(),
    )
  }
}
