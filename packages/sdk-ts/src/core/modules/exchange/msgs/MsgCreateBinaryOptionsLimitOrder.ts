...
export declare namespace MsgCreateBinaryOptionsLimitOrder {
  ...
  export type Proto =
    InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsLimitOrder
}
...
const createLimitOrder = (params: MsgCreateBinaryOptionsLimitOrder.Params) => {
  ...
  const message =
    InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsLimitOrder.create({
...
> {
  ...
  public toBinary(): Uint8Array {
    return InjectiveExchangeV1Beta1TxPb.MsgCreateBinaryOptionsLimitOrder.toBinary(
      this.toProto(),
    )
  }
}
