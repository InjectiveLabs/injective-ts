...
export class ExchangeGrpcExplorerTransformer {
  ...
  static grpcTransactionsToTransactions(
    ...
    return txs.map((tx) =>
      ExchangeGrpcExplorerTransformer.grpcTransactionToTransaction(tx),
    )
  }
  ...
  static grpcBlocksToBlocks(blocks: Array<BlockInfo>): Array<Block> {
    return blocks.map((block) =>
      ExchangeGrpcExplorerTransformer.grpcBlockToBlock(block),
    )
  }
  ...
  static grpcBlocksToBlocksWithTxs(
    ...
    return blocks.map((block) =>
      ExchangeGrpcExplorerTransformer.grpcBlockToBlockWithTxs(block),
    )
  }

  static grpcValidatorDescriptionToValidatorDescription(
    validatorDescription: GrpcExchangeValidatorDescription,
  ): ExplorerValidatorDescription {
    return {
