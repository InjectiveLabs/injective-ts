...
export class DerivativeGrpcTransformer {
  ...
  static grpcMarketToMarket(
    ...
    return {
      ...
      quoteToken: DerivativeGrpcTransformer.grpcTokenMetaToTokenMeta(
      ...
      perpetualMarketInfo:
        DerivativeGrpcTransformer.grpcPerpetualMarketInfoToPerpetualMarketInfo(
          market.getPerpetualMarketInfo(),
        ),
      perpetualMarketFunding:
        DerivativeGrpcTransformer.grpcPerpetualMarketFundingToPerpetualMarketFunding(
          market.getPerpetualMarketFunding(),
        ),
      expiryFuturesMarketInfo:
        DerivativeGrpcTransformer.grpcExpiryFuturesMarketInfoToExpiryFuturesMarketInfo(
  ...
  static grpcMarketsToMarkets(
    ...
    return markets.map((market) =>
      DerivativeGrpcTransformer.grpcMarketToMarket(market),
    )
  }
  ...
  static grpcPriceLevelsToPriceLevels(
    ...
    return priceLevels.map((priceLevel) =>
      DerivativeGrpcTransformer.grpcPriceLevelToPriceLevel(priceLevel),
    )
  }
  ...
  static grpcOrderbookToOrderbook({
    ...
    return {
      buys: DerivativeGrpcTransformer.grpcPriceLevelsToPriceLevels(buys),
      sells: DerivativeGrpcTransformer.grpcPriceLevelsToPriceLevels(sells),
    }
  }
  ...
  static grpcTradeToTrade(trade: GrpcDerivativeTrade): DerivativeTrade {
    ...
    const mappedPositionDelta = positionDelta
      ? DerivativeGrpcTransformer.grpcPositionDeltaToPositionDelta(
          positionDelta,
        )
      : zeroPositionDelta()
  ...
  static grpcFundingPaymentsToFundingPayments(
    ...
    return fundingPayments.map(
      DerivativeGrpcTransformer.grpcFundingPaymentToFundingPayment,
    )
  }
  ...
  static grpcFundingRatesToFundingRates(
    ...
    return fundingRates.map(
      DerivativeGrpcTransformer.grpcFundingRateToFundingRate,
    )
  }
}
