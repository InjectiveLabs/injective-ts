...
export class AccountTransformer {
  ...
  static grpcAccountPortfolioToAccountPortfolio(
    ...
    return {
      ...
      subaccountsList: portfolio
        .getSubaccountsList()
        .map(AccountTransformer.grpcSubaccountPortfolioToSubaccountPortfolio),
    }
  }
  ...
  static grpcBalanceToBalance(
    ...
    return {
      ...
      deposit: deposit
        ? AccountTransformer.grpcDepositToDeposit(deposit)
        : undefined,
    }
  }
  ...
  static grpcTransferHistoryEntryToTransferHistoryEntry(
    ...
    return {
      ...
      amount: amount
        ? AccountTransformer.grpcAmountToAmount(amount)
        : undefined,
    }
  }
  ...
  static grpcTradingRewardsToTradingRewards(
    ...
    return rewards.map(AccountTransformer.grpcTradingRewardToTradingReward)
  }
  ...
  static grpcTransferHistoryToTransferHistory(
    ...
    return transfers.map((transfer) =>
      AccountTransformer.grpcTransferHistoryEntryToTransferHistoryEntry(
        transfer,
      ),
    )
  }
