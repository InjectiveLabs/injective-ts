...
export const checkAndGetCanonical = (
  token: Token,
): Array<{ tokenType: TokenType; source: TokenSource }> | undefined => {
  ...
  if (
    ...
    return [
      { tokenType: TokenType.Ibc, source: TokenSource.Ibc },
      { tokenType: TokenType.Erc20, source: TokenSource.Ethereum },
    ]
  }
