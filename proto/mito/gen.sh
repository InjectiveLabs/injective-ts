# DEPRECATION WARNING
echo "❌ ERROR: This script is deprecated, use protoV2/mito/gen.sh instead" >&2
exit 1
...
git clone https://github.com/MitoFinance/mito-indexer.git $BUILD_DIR -b $mito_indexer_branch --depth 1 --single-branch > /dev/null
...
## 5. Setup proper package.json for mito-proto-ts packages
cp $TS_STUB_DIR/package.json.mito-proto-ts.template $TS_OUTPUT_DIR/package.json
