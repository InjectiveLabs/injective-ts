...
find $BUILD_DIR/api/proto -name '*.proto' -exec cp {} $PROTO_DIR \;
...
## 5. Setup proper package.json for olp-proto-ts packages
cp $TS_STUB_DIR/package.json.olp-proto-ts.template $TS_OUTPUT_DIR/package.json
